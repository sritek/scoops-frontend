...
export default function PaymentPage() {
  ...
  const {
    ...
    isLoading,
    error,
  } = usePublicPaymentLink(shortCode);
        ...
        <Card className="max-w-md w-full">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600">
              This payment link may have expired or been cancelled. Please
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm text-green-700">
                This fee has already been paid. Thank you!
              </p>
            </div>
          </div>
        </div>
          ...
          <CardHeader className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-t-lg">
            <CardTitle className="text-center">
              <div className="text-3xl font-bold mb-1">
                ₹{paymentLink.amount.toLocaleString("en-IN")}
              </div>
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex justify-between py-3 border-b border-gray-100">
                ...
                <span className="font-medium text-gray-900">
                  #{paymentLink.installment.number} • Due{" "}
                  {format(
                    new Date(paymentLink.installment.dueDate),
                    "dd MMM yyyy",
                  )}
                </span>
              </div>
                ...
                {paymentLink.razorpayUrl ? (
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm text-amber-800">
                      Online payment is not available. Please contact the school
                      to make the payment.
                    </p>
                  </div>
                )}
            ...
            <p className="text-xs text-gray-500 text-center mt-6">
              Secure payment powered by Razorpay. For any issues, contact the
